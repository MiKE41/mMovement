...
namespace mMovement
{
    internal class Memory
    {
        ...
        private static class Signatures
        {
            ...
            internal const string g_PlayerMoveControllerSignature = "48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8D 8B ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 83 3D ?? ?? ?? ?? ?? 74 0D E8 ?? ?? ?? ?? 48 8B C8"; //Client::Game::GameMain_Update
            internal const string g_InputManager_MouseButtonHoldStateSignature = "39 1D ?? ?? ?? ?? 74 14 48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 84 C0 0F 84 ?? ?? ?? ?? BB ?? ?? ?? ?? E9 ?? ?? ?? ?? F3 0F 10 8E ?? ?? ?? ?? 0F 57 C0 0F 2E C8 7A 78 75 76";
        }
